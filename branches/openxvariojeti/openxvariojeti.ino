...
#define JetiVersionStr "Ver. 22.03.2013 "
...
/* JETIDUPLEX Version 22.3.2013   (based on openXvario version r131)                   */
...
//#define KALMANDUMP  // for filter process visualization. Output the measured and estimated pressure 
...
void setup()
{
  ...
  for (i=i; i<40; i++)     // Display welcome message for 40 x 0,08 s on classic jetibox terminal
  {
    ...
    digitalWrite (PIN_greenLED, (i & 1)); digitalWrite (PIN_redLED, 1-(i & 1));
#endif // DUOLED
  }
#endif // JETIDUPLEX
